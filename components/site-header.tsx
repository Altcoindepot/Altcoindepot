...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-[#f4ddc3]/20 bg-[#0b0d11]/78 backdrop-blur-xl">
      <div className="relative flex w-full items-center justify-center px-2 py-3 sm:px-3">
        ...
        <Link
          href="/"
          className="header-home-link relative z-20 inline-flex rounded-sm px-4 text-center focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d1a173]"
        >
