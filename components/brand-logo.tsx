...
/** Shared A+coin mark paths (matches public/logo-mark.svg). */
...
export function BrandLockup({ className = "" }: { className?: string }) {
  return (
    <span className={`inline-flex items-center gap-2 ${className}`.trim()}>
      ...
      <span className="flex items-baseline whitespace-nowrap text-[1.35rem] font-extrabold leading-none tracking-[-0.04em] sm:text-[1.5rem]">
