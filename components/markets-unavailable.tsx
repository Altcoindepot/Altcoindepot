...
export function MarketsUnavailable({
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-lg rounded-xl border border-red-500/30 bg-[var(--surface-inset)] p-8">
        ...
        <div className="mt-6 flex flex-col items-stretch gap-2 sm:flex-row sm:justify-center">
          <Link
            href={onRetryHref}
            className="inline-flex min-h-12 items-center justify-center rounded-lg border border-teal-400/45 bg-teal-500/15 px-5 text-sm font-semibold text-teal-300"
          >
            Reload markets
          </Link>
          <Link
