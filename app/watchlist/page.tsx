  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        <h1 className="text-brand-altcoindepot text-2xl font-bold tracking-tight">Watchlist</h1>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg border border-white/15 px-3 text-sm text-zinc-400 hover:border-red-400/40 hover:text-red-300"
                  >
                    Remove
                  </button>
                </li>
